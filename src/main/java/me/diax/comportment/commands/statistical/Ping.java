 ...
 * @author Comportment
 */
@CommandDescription(name = "ping", triggers = {
        "ping", "pang", "pong", "pung", "peng"
}, attributes = {
...
public class Ping implements Command {
    ...
    public void execute(Message message, String s) {
        message.getChannel().sendMessage(MessageUtil.basicEmbed("Pinging...")).queue(pinging -> {
            long ping = message.getCreationTime().until(pinging.getCreationTime(), ChronoUnit.MILLIS);
