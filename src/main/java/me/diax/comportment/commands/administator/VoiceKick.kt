 ...
 * @author Comportment
 */
@CommandDescription(name = "voicekick", triggers = arrayOf("voicekick", "vkick"), attributes = arrayOf(CommandAttribute(key = "description", value = "Kicks the mentioned users from a voice channel.")))
