...
public class MusicTrack implements AudioTrack {
    ...
    public MessageEmbed getCard() {
        EmbedBuilder eb = MessageUtil.defaultEmbed()
        ...
        if (this.track instanceof YoutubeAudioTrack) {
            eb.setThumbnail(String.format("https://img.youtube.com/vi/%s/default.png", this.getIdentifier()));
        }
        return eb.build();
    }
