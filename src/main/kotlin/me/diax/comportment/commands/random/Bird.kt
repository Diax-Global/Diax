 ...
 * @author Comportment
 */
@CommandDescription(name = "bird", triggers = arrayOf("bird", "birb"), attributes = arrayOf(CommandAttribute(key = "allowPrivate"), CommandAttribute(key = "description", value = "Shows a random bird picture")))
class Bird : Command {
